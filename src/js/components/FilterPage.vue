                    ...
                    <div class="card-body">
                        ...
                        <div class="header-form">
                            <input class="form-control" type="text"
                                   placeholder="Gib hier deine Postleitzahl ein um lokale Angebote zu sehen."
                                   v-model="zip">
                            <div class="dropdown">
                                <button v-if="forHelpee" class="btn btn-lg btn-primary corona-compass-btn" type="button"
                                        id="dropdownMenuButton"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-search"></i> Hilfe suchen
                                </button>
                                <button v-if="forHelper" class="btn btn-lg btn-secondary corona-compass-btn"
        ...
        <section class="results">
            <div class="container" v-if="forHelpee">
                ...
                <div class="result-list">
                    <div class="card" v-for="initiative in initiatives" v-bind:key="initiative.slug">
                        <div class="card-body">
                            <div class="result-item">
                                <div class="result-logo" v-if="initiative.images && initiative.images.length > 0">
                                    <img :src="initiative.images[0].url" :alt="initiative.images[0].filename"
                                         class="img-fluid">
                                </div>
                                <div class="result-header">
                                    ...
                                    <div class="badges">
                                        <span class="badge badge-primary"
                                              v-if="initiative.zips.length">Lokales Angebot</span>
                                ...
                                <div class="result-body">
                                    ...
                                    <div class="buttons">
                                        <router-link :to="{ name: 'helpeeDetail', params: { slug: initiative.slug } }"
                                                     class="btn btn-sm btn-secondary mr-1">
                                            <i class="fa fa-info-circle"></i> Mehr dazu
                                        </router-link>

                                        <a v-if="initiative.contactPhone" :href="'tel:' + initiative.contactPhone"
                                           class="btn btn-sm btn-dark mr-1">
                                            <i class="fa fa-phone"></i> Anrufen
                                        </a>

                                        <a v-if="initiative.contactURL" :href="initiative.contactURL" target="_blank"
                                           class="btn btn-sm btn-dark mr-1">
                        ...
                        <div class="card-body">
                            <div class="result-item">
                                ...
                                <div class="result-body">
                                    <p>{{ initiative.descriptionShort }}</p>
                                    <div class="buttons">
                                        <router-link :to="{ name: 'helperDetail', params: { slug: initiative.slug } }"
                                                     class="btn btn-sm btn-secondary mr-1">
                                            <i class="fa fa-info-circle"></i> Mehr dazu
                                        </router-link>
...
<script>
    export default {
        ...
        created() {
            this.zip = this.$route.query.zip || null;
        },
        methods: {
            updateQuery() {
                this.$router.push({ path: this.$route.path, query: this.zip ? { zip: this.zip } : {} })
            }
        },
        computed: {
